<?php
  ...
  $_SESSION['where'] = "StatusCode = 'DELETED'";
...
<html class="no-js">
  ...
  <body>
    <div id="resultsbackground">
      ...
      <!--<form action="export.php?table=<?= $tableName ?>" method="POST">-->
      <form action="delete.php?table=<?= $tableName ?>" method="POST">
        <input type="submit" name="export_all_delete" value="Export All"/>
        <input type="submit" name="export_selected_delete" value="Export Selected">
        ...
        <input type="submit" name="selected" value="Delete Selected" />
