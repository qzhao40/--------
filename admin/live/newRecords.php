...
<html class="no-js">
  <head>
    ...
    <script type="text/javascript">
      ...
      //  declare array for tfoot inputs
  ...
  <body>
    <div id="resultsbackground">
      ...
      <h3>New <?= $tableName ?> Records</h3>
      <form action="transfer.php?table=<?= $tableName ?>" method="POST">
        <input type="submit" name="export_all_new" value="Export All"/>
        <input type="submit" name="export_selected_new" value="Export Selected">
        <!-- id created for test.js -->
        <button type="button" id="btn1">Select All</button>
        <button type="button" id="btn2">Unselect All</button>
        <br/>
        <input type="submit" name="all" value="Transfer All" />
        <input type="submit" name="selected" value="Transfer Selected" />
