...
<html class="no-js"> <!--<![endif]-->
  ...
  <body>
      <div id="resultsbackground">
        ...
        <h2 class="volunteerSpeal">Select a table to see its contents and search it.</h2>
        <h4 class="volunteerSpeal">You are currently connected to the Production Database.</h4>
        ...
        <form action="table.php" method="get">
          <select name="tableName" id="tableName">
            <?php $and = "AND TABLE_NAME NOT IN('Purchases', 'Category', 'Products')"; ?>
