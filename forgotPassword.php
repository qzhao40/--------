	    ...
	    <div id="container" class="home">
	        <?php require('header.php'); ?>
	      	<form name="forgotPasswordForm" method="post" action="forgotPasswordQuery.php">
		        ...
		        <p class="speal"> **NOTE**  Your user name and email must match what is in the MGS membership database. If you are still having problems with your account email   mani@mbgenealogy.com   providing your name and member number. Allow several days for a reply as we are a volunteer run organization.
		</p class="speal">
