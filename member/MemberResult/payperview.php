<?php
  ...
  if(isset($_POST) && !empty($_POST)){
      ...
      if(file_exists("../../PDF/".$folder."/".$fileName.".pdf")){
        ...
        $message = "There was a problem retrieving the download link for " . $fileName. ". Please contact MGS to receive your purchase.";
      }
      $_POST = array();
  }
