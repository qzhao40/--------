<?php
    ...
    $searchColumns = retrieveColumns($sTable, $and, $userConn);
    ...
    $rResult = sqlsrv_query($userConn, $sQuery, array($memberNum, $memberNum), array("Scrollable" => "static"));
    ...
    $rResultCnt = sqlsrv_query($userConn, $sQueryCnt, array($memberNum), array("Scrollable" => "static"));
    ...
    $rResultTotal = sqlsrv_query($userConn, $sQueryTotal, array($memberNum), array("Scrollable" => "static"));
